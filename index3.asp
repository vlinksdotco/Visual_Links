...
<body style="text-align: center;"><!-- Navigation --><nav>  <ul class="w3-navbar w3-blue">    <li><a href="javascript:void(0)">Home</a></li>    <li><a href="javascript:void(0)">About</a></li>    <li><a href="javascript:void(0)">Terms of use</a></li>    <li><a href="javascript:void(0)">Login</a></li>    <li><a href="javascript:void(0)">Register</a></li>    <li><a href="javascript:void(0)">Contact</a></li>  </ul></nav><br>
 ...
 <header> 
    <img id="logo" src="pic2/vlinks.co.png"   alt="Visual Links's Logo" title="Show me main page" 
         style="margin:auto; border: 1; box-shadow: 3px 3px 2px #585858;"     
 ...
 <div id="input_bar""> 
  <div id="bar">                                 
    <form method="get"  name="searchBox" autocomplete="on">    
      ...
      <button title="Press it for Visual Search" onclick="submitForm()">&nbsp;Search&nbsp;</button>&nbsp;&nbsp;
      <img class="plus" src="/images/plus.png" alt="Add your site/Report for broken link"
           title="Add your site / Report for broken link" 
           style="margin-top: -5px; position:absolute; height:auto; width:auto; cursor:pointer; border:0;" onclick="showse()">
    </form>
 </div>
...
<h3>OUR ADVERTISERS</h3><div style="text-align: center;" class="img">
  <a href="http://www.vlinks.co/vlinks_ads.asp" target="_blank" id="a1"> 
      <img src="images/adver.png" alt="ad website" title="Your website can be here too !" style="box-shadow: 3px 3px 2px #585858;"
        onclick='aclick("openpage.asp?id=2625")' id="a2"></a></div><div class="img">
  <a href="http://www.vlinks.co/vlinks_ads.asp" target="_blank" id="b1">
      <img class="ad-photo" src="images/adver.png" alt="ad website" 
        ...
        onclick='aclick("openpage.asp?id=2625")' id="b2"></a></div><div class="img">
  <a href="http://www.vlinks.co/vlinks_ads.asp" target="_blank" id="c1">
      <img class="ad-photo" src="images/adver.png" alt="ad website" 
        title="Your website can be here too !" style="box-shadow: 3px 3px 2px #585858;"
        onclick='aclick("openpage.asp?id=2625")' id="c2"></a></div><div class="img">
  <a href="http://www.vlinks.co/vlinks_ads.asp" target="_blank" id="d1">
      <img class="ad-photo" src="images/adver.png" alt="ad website" 
        title="Your website can be here too !" style="box-shadow: 3px 3px 2px #585858;"
        onclick='aclick("openpage.asp?id=2625")' id="d2"></a></div><div class="img">
...
%><div class="img"><a href="<%=rs2("url")%>" target="_blank"><img id="new_link" src="pic2/<%=rs2("pic")%>" title="<%=rs2("rev")%>" alt="New Link"  
style="box-shadow: 3px 3px 2px #585858;"                   
onmouseover="window.status='<%=rs2("url")%>'" onmouseout="window.status=''" 
onclick='aclick("openpage.asp?id=<%=rs2("id")%>")'></a><br>
</div>
...
<div id=se style="/*text-align:center; position:absolute; left:20%; top:10%; */margin:auto;
